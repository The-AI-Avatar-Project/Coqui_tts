...
RUN apt-get update && apt-get install -y build-essential python3-dev libblas-dev liblapack-dev
RUN /app/bin/pip3 install blis==0.7.11 --only-binary :all:
